...
Instalează `cod-reducere-flanco` prin NPM:
...
```javascript
var codes = require('cod-reducere-flanco')

console.log(codes)

// [
//   {
//     site: 'https://www.flanco.ro',
//     cod_reducere: 'FLANCO10',
...
Cod-reducere-flanco a fost creat de echipa de la [Cuponescu](https://cuponescu.ro/) pentru a ajuta cu testarea.
